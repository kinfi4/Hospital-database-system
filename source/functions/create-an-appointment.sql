...
$create_appoint$
    ...
    BEGIN
        ...
        free_cabinets := ARRAY(
                        ...
                        WHERE da.building_id = doctor_building_id AND da.is_closed = False AND (
        ...
        INSERT INTO doctor_appointment(patient_id, doctor_id, building_id, cabinet_number, time, reason, is_closed, duration_minutes)
            VALUES
        ($2, $1, doctor_building_id, random_cabinet_number, appointment_time, appointment_reason, False, appointment_duration_minutes);
    END
$create_appoint$
